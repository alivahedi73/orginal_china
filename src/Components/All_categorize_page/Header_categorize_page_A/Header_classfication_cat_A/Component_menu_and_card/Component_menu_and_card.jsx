...
const Component_menu_and_card = ({rang,data_left,data_right,id}) => {
  return (
    <>
      <div className="menu_card_components" id={`item_${id}`}>
        <div className="menu_bar_components">
          <Compon_left_side_menu_card rang={rang} data={data_left} />
        </div>
        <Menu_bar_components_mobile data={data_left} id={`item_${id}`} />
