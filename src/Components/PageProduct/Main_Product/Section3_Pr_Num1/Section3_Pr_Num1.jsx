  ...
  return (
    <>
      <div className="Section3__product__num1">
        {/* start of basic info */}
        <div className="Section3__product__BasicInfo">
          <h3 className="Section3__product__BasicInfo_h3">Basic Info.</h3>
        ...
        <div className="Section3__product_productDescription">
          <h3 className="Section3__product__productDescription_h3">
            Product Description
          </h3>
        ...
        <div className="Section3__CompanyInfo_main">
          <div className="sec3__company_div1"></div>
          <h4>Introduction:</h4>
